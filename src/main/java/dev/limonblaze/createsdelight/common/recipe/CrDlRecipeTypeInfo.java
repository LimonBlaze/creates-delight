...
public enum CrDlRecipeTypeInfo implements IRecipeTypeInfo {
    TOOL_APPLICATION(ToolApplicationRecipe::new);
    ...
    CrDlRecipeTypeInfo(Supplier<RecipeSerializer<?>> serializerSupplier, Supplier<RecipeType<?>> typeSupplier) {
        this.id = CreatesDelight.asResource(Lang.asId(name()));
        this.serializerSupplier = serializerSupplier;
        this.typeSupplier = typeSupplier;
    }
    
    CrDlRecipeTypeInfo(Supplier<RecipeSerializer<?>> serializerSupplier, RecipeType<?> existingType) {
        this(serializerSupplier, () -> existingType);
    }
    
    CrDlRecipeTypeInfo(Supplier<RecipeSerializer<?>> serializerSupplier) {
        this.id = CreatesDelight.asResource(Lang.asId(name()));
        this.serializerSupplier = serializerSupplier;
        this.typeSupplier = () -> simpleType(id);
    }
    
    CrDlRecipeTypeInfo(ProcessingRecipeBuilder.ProcessingRecipeFactory<?> processingFactory) {

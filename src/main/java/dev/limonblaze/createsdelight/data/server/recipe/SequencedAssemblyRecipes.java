...
public class SequencedAssemblyRecipes extends CreateRecipeProvider {
    ...
    public SequencedAssemblyRecipes(DataGenerator generator) {
        super(generator);
    }
    ...
    CHEESE_BURGER = create("cheese_burger",
        builder -> builder
            ...
            .addStep(DeployerApplicationRecipe::new, b -> b.require(ModItems.BEEF_PATTY.get()))
            .addStep(DeployerApplicationRecipe::new, b -> b.require(CommonIngredients.ONION))
            .addStep(FillingRecipe::new, b -> b.require(CDTags.FluidTag.TOMATO_SAUCE, 250))
    ),
    ...
    MUTTON_WRAP = create("mutton_wrap",
        builder -> builder
            .require(ForgeTags.BREAD)
            .transitionTo(CDItems.INCOMPLETE_MUTTON_WRAP.get())
    ...
    HAM_WRAP = create("ham_wrap",
        builder -> builder
            .require(ForgeTags.BREAD)
            .transitionTo(CDItems.INCOMPLETE_HAM_WRAP.get())
            .addOutput(CDItems.HAM_WRAP.get(), 1)
            .loops(1)
            .addStep(DeployerApplicationRecipe::new, b -> b.require(ModItems.SMOKED_HAM.get()))
            .addStep(DeployerApplicationRecipe::new, b -> b.require(ForgeTags.SALAD_INGREDIENTS))
            .addStep(FillingRecipe::new, b -> b.require(CDTags.FluidTag.CREAM, 250))
    ),
    NETHER_WRAP = create("nether_wrap",
        builder -> builder
            .require(ForgeTags.BREAD)
            .transitionTo(CDItems.INCOMPLETE_NETHER_WRAP.get())
            .addOutput(CDItems.NETHER_WRAP.get(), 1)
            .loops(1)
            .addStep(DeployerApplicationRecipe::new, b -> b.require(Items.CRIMSON_FUNGUS))
            .addStep(DeployerApplicationRecipe::new, b -> b.require(Items.WARPED_FUNGUS))
            .addStep(DeployerApplicationRecipe::new, b -> b.require(Items.MAGMA_CREAM))
    ),

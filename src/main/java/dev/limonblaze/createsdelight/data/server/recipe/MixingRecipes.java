...
public class MixingRecipes extends ProcessingRecipes {
    ...
    SOUR_CREAM_AND_CHEESE = create("sour_cream_and_cheese",
        builder -> builder
            .require(CDTags.FluidTag.YOGURT, 500)
            .require(CommonIngredients.SALT)
            .requiresHeat(HeatCondition.HEATED)
    ...
    BUTTER = create("butter",
        builder -> builder
            .require(CDTags.FluidTag.CREAM, 500)
            .require(CommonIngredients.SALT)
            .output(CDItems.BUTTER.asStack())
    ),
    MELT_BUTTER = create("melt_butter",
        builder -> builder
            .require(CDItems.BUTTER.get())
            .requiresHeat(HeatCondition.HEATED)
            .output(CDFluids.BUTTER.get(), 250)
    ),
    ...
    public MixingRecipes(DataGenerator dataGenerator) {
        super(dataGenerator);
    }
